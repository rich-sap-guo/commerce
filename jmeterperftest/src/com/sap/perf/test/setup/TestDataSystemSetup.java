 ...
 */
package com.sap.perf.test.setup;
...
import com.sap.perf.test.constants.JmeterperfTestConstants;
import com.sap.perf.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = JmeterperfTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/jmeterperftest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/jmeterperftest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/jmeterperftest/import/cstickets.impex");
			...
			importImpexFile(context, "/jmeterperftest/import/csquotes.impex");
		}
	}
}
